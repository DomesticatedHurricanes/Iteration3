...
//                // TODO very hacky but i cant figure out a way to have a pathfinder without knowing these conditions
//                int z = map.getTile(x,y).getPoint3D().getZ();
//                nodes[x][y] = new Node(x,y,z);
//            }
//        }
//    }
//
...
//                    }
//
//                    if (isValidLocation(sx, sy,sz, xp, yp,zp)) {
...
//    }
//
//    protected boolean isValidLocation( int sx, int sy, int sz, int x, int y, int z) {
//        boolean invalid = (x < 0) || (y < 0) || (x >= map.getWidth()) || (y >= map.getHeight());
//
//        if ((!invalid) && ((sx != x) || (sy != y))) {
//            invalid = map.isBlocked(x, y);
//            if (invalid){
//                invalid = map.isValid(sz,z);
//            }
//        }
//        return !invalid;
//    }
